...
import datetime
datetime_str = 'encoder_is_pretrained_average.py_gpt2tokenizer_'+ datetime.datetime.now().strftime('%Y-%m-%d--%H:%M:%S')
...
import os
import shutil
src_path = os.getcwd() + '/encoder_is_pretrained_average.py'
